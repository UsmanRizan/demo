...
export default function NewLocationForm() {
  ...
  function useMyLocation() {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        handleMapLocation(position.coords.latitude, position.coords.longitude);
        setGeoLoading(false);
      },
      () => {
          ...
          <div className="mt-8">
            ...
            <div className="mt-3 flex items-center gap-3">
              <button
                ...
                disabled={geoLoading}
                className="inline-flex items-center gap-1.5 rounded-lg border border-gray-300 px-3 py-1.5 text-sm font-medium hover:bg-gray-50 disabled:opacity-50"
              >
                {geoLoading ? (
                  <>Locating...</>
                ) : (
